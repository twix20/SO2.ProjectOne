...
SecondWindowController::SecondWindowController(const int height, const int width)
{
	...
	init_pair(11, COLOR_CYAN, COLOR_GREEN);
	...
	init_pair(35, COLOR_WHITE, COLOR_CYAN);
	init_pair(36, COLOR_WHITE, COLOR_MAGENTA);
	init_pair(37, COLOR_WHITE, COLOR_YELLOW);
	init_pair(38, COLOR_WHITE, COLOR_WHITE);
	init_pair(39, COLOR_GREEN, COLOR_GREEN);
	init_pair(40, COLOR_GREEN, COLOR_BLUE);
	init_pair(41, COLOR_GREEN, COLOR_RED);
	init_pair(42, COLOR_GREEN, COLOR_CYAN);
	init_pair(43, COLOR_GREEN, COLOR_MAGENTA);
	init_pair(44, COLOR_GREEN, COLOR_YELLOW);
	init_pair(45, COLOR_GREEN, COLOR_WHITE);
	init_pair(46, COLOR_BLUE, COLOR_GREEN);
	init_pair(47, COLOR_BLUE, COLOR_BLUE);
	init_pair(48, COLOR_BLUE, COLOR_RED);
	init_pair(49, COLOR_BLUE, COLOR_CYAN);
